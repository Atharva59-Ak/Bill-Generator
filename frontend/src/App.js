      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-foreground group-hover:text-blue-600 transition-colors duration-300">InvoiceForge</span>
                <span className="text-xs text-gray-500 dark:text-muted-foreground font-medium hidden lg:block">AI-Powered Invoicing</span>
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-1 xl:space-x-2">
            <a href="#features" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-50/80 dark:hover:bg-blue-500/20">
            ...
            <Link to="/templates" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-50/80 dark:hover:bg-blue-500/20">
              <span className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link to="/pricing" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-50/80 dark:hover:bg-blue-500/20">
              <span className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user && (
              <>
                ...
                <Link to="/create" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-green-600 rounded-lg transition-all duration-300 hover:bg-green-50/80 dark:hover:bg-green-500/20 bg-green-50/30 dark:bg-green-500/20 border border-green-100/50 dark:border-green-500/30">
                  <span className="flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Link to="/enhanced-invoices" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-purple-600 rounded-lg transition-all duration-300 hover:bg-purple-50/80 dark:hover:bg-purple-500/20">
                  <span className="flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Link to="/business-profile" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-indigo-600 rounded-lg transition-all duration-300 hover:bg-indigo-50/80 dark:hover:bg-indigo-500/20">
                  <span className="flex items-center space-x-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link to="/contact" className="nav-link group px-4 py-2 text-sm font-medium text-gray-700 dark:text-foreground hover:text-blue-600 rounded-lg transition-all duration-300 hover:bg-blue-50/80 dark:hover:bg-blue-500/20">
              <span className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <>
                ...
                <button 
                  onClick={onLogout}
                  className="hidden lg:flex items-center space-x-2 text-gray-600 dark:text-foreground hover:text-red-600 font-medium transition-all duration-300 px-4 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-500/20 border border-gray-200 dark:border-border hover:border-red-200 dark:hover:border-red-500 group"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <>
                <button 
                  onClick={onAuthClick}
                  className="hidden lg:flex items-center space-x-2 text-gray-600 dark:text-foreground hover:text-gray-900 dark:hover:text-foreground font-medium transition-all duration-300 px-4 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-secondary border border-gray-200 dark:border-border hover:border-gray-300 dark:hover:border-border"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg text-gray-600 dark:text-foreground hover:text-gray-900 dark:hover:text-foreground hover:bg-gray-100 dark:hover:bg-secondary transition-all duration-200"
            >
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 dark:border-border bg-white/95 dark:bg-card/95 backdrop-blur-md">
            <div className="px-4 py-6 space-y-4">
              ...
              <a href="#features" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center space-x-3 text-gray-700 dark:text-foreground hover:text-blue-600 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-500/20 transition-all duration-200">
              ...
              <Link to="/templates" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center space-x-3 text-gray-700 dark:text-foreground hover:text-blue-600 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-500/20 transition-all duration-200">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4h4a2 2 0 002-2V5z" />
                </svg>
              ...
              <Link to="/pricing" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center space-x-3 text-gray-700 dark:text-foreground hover:text-blue-600 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-500/20 transition-all duration-200">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
...
const AnimatedInvoicePreview = () => {
  ...
  return (
    <div className={`relative transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
      {/* Main Invoice Card */}
      <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-white dark:bg-card border border-gray-200 dark:border-border hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <div className="bg-white/95 dark:bg-card/95 backdrop-blur-md rounded-xl p-6 border border-white/20 dark:border-border/20 shadow-xl">
            
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-foreground flex items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-secondary transition-colors duration-200">
                <span className="text-gray-600 dark:text-muted-foreground font-medium">Tax (10%):</span>
                <span className="font-bold text-lg">$250.00</span>
              </div>
              <div className="border-t-2 border-gray-200 dark:border-border pt-4">
                <div className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-500/20 dark:to-purple-500/20 rounded-lg">
                  <span className="text-gray-900 dark:text-foreground font-bold text-lg">Total:</span>
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button className="px-4 py-2 border border-gray-300 dark:border-border text-gray-700 dark:text-foreground rounded-lg hover:bg-gray-50 dark:hover:bg-secondary transition-colors duration-300">
      ...
      {/* Stats Cards */}
      <div className="absolute -left-8 top-1/2 transform -translate-y-1/2 w-24 h-16 bg-white dark:bg-card rounded-lg shadow-lg border border-gray-200 dark:border-border p-3 animate-float" style={{animationDelay: '2s'}}>
        <div className="text-xs text-gray-500 dark:text-muted-foreground">Revenue</div>
        <div className="text-sm font-bold text-green-600">+15%</div>
      </div>

      <div className="absolute -right-8 top-1/4 w-20 h-20 bg-white dark:bg-card rounded-xl shadow-lg border border-gray-200 dark:border-border p-3 animate-float" style={{animationDelay: '1.5s'}}>
        <div className="text-xs text-gray-500 dark:text-muted-foreground mb-1">Invoices</div>
...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-background dark:via-card dark:to-background pt-20 pb-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fadeInUp" style={{animationDelay: '0.2s'}}>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-foreground mb-6 leading-tight">
              Create Professional 
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button className="border-2 border-gray-300 dark:border-border text-gray-700 dark:text-foreground px-8 py-4 rounded-xl font-semibold hover:border-blue-500 hover:text-blue-600 transition-all duration-300 transform hover:scale-105">
                Watch Demo
              </button>
            </div>
  ...
  return (
    <div className="App bg-background text-foreground">
      <BrowserRouter>
        ...
        <div style={fixedThemeToggleStyle}>
          <ThemeToggle />
        </div>
